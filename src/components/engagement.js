...
const KEYS = {
  firstOpen: 'linclaw_first_open',
  openCount: 'linclaw_open_count',
  lastShown: 'linclaw_engage_shown',
  never: 'linclaw_engage_never',
  todayDismiss: 'linclaw_engage_today',
}
...
export function tryShowEngagement() {
  ...
  const shareText = '推荐一个开源的 OpenClaw 管理面板 — LinClaw，一键搭建、便捷管理模型和 Agent，还内置 AI 助手帮你排查问题，小白也能轻松上手 👉 https://linclaw.qnlinking.com/'
  ...
  overlay.innerHTML = `
    <div class="engage-modal">
      ...
      <div class="engage-header">
        ...
        <div class="engage-title">感谢你使用 LinClaw</div>
      </div>

      <div class="engage-message">
        LinClaw 是一个<strong>完全开源、免费</strong>的项目，由晴辰云团队专职维护、持续更新。如果它帮到了你，对我们最大的鼓励就是：
      </div>

      <div class="engage-actions-grid">
        <a class="engage-action-card" href="https://github.com/sunqirui1987/linclaw" target="_blank" rel="noopener">
