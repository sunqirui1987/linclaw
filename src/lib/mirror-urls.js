...
const GITHUB_ORG = 'https://github.com/sunqirui1987'
const GITEE_ORG = 'https://gitee.com/QtCodeCreators'
const GITHUB_RAW = 'https://raw.githubusercontent.com/sunqirui1987'
 ...
 * @param {string} repo - 仓库名，如 'linclaw'
...
export function deployCommand() {
  return {
    github: `curl -fsSL ${GITHUB_RAW}/linclaw/main/deploy.sh | bash`,
    gitee: `curl -fsSL ${GITEE_RAW}/linclaw/raw/main/deploy.sh | bash`,
  }
}
